                ...
                var activities = new List<Activity>
                {
                    ...
                    new Activity
                    {
                        ...
                        Description = @"<p>Το 6o Athens Street Food Festival έρχεται τον Μάϊο και αναζητά τις καλύτερες γεύσεις από ολόκληρο τον Γαλαξία!</p>
                                    <p>Όταν ξεκίνησε το Athens Street Food Festival το 2016, η έννοια του street food στην Ελλάδα ήταν πρακτικά ανύπαρκτη.
                                    ...
                                    <p>Στο φετινό, 6ο Athens Street Food Festival, ο στόχος μας είναι η παρουσίαση μοναδικών και ιδιαίτερων γεύσεων
